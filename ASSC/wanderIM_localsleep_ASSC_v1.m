...
tbl=array2table(all_Waves_byProbes,'VariableNames',{'SubID','nProbe','nBlock','Task','nTrial','State','Vig','Chan','State2','nWave','UpSlope','DownSlope','Amp','P2PAmp','RT','GO','NOGO'});
tbl(tbl.State==4,:)=[];
...
for nE=1:63
    for nS=1:length(myS)
        ...
        [r_NOGO(nS,nE) pV_NOGO(nS,nE)]=corr(this_tbl.nWave,this_tbl.Vig,'type','pearson','rows','pairwise');
