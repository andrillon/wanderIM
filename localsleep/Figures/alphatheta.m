...
for n=1:length(bsl_files)
    ...
    for nE = 1:63
        ...
        rho = corr(a,b); % correlation of a/t ratio and sleepiness rating
...
%     right_freq(n)=SubjectInfo.FlickerL;
    ...
    subplot(5,4,n);
    simpleTplot(-1.5:0.002:1.5, mean(erp));
    xlabel(SubID);
    erp_all=[erp_all; erp];
...
title('ERP for Theta(80) Events for Fz(Ch2) for each participant');
