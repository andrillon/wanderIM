...
for n=1:length(bsl_files)
    ...
    if exist([eeg_path filesep 'wanderIM_cont_twa5_noica_' SubID '.mat'])==0 || redo==1
    ...
    [twa_results]=twalldetectnew_TA_v2(temp_data,D.fsample,0);
        all_Waves=[];
        for nE=1:63
    ...
    save([eeg_path filesep 'wanderIM_cont_twa5_noica_' SubID],'all_Waves')
