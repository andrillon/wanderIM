...
all_probes_mat=[];
all_probes_mat2=nan(20*6*10*length(bsl_files),142);
all_probes_STD=[];
all_probes_DEV=[];
all_probes_behav=[];
all_probes_P3amp=[];
all_probes_mat3=nan(20*64*6*10*length(bsl_files),19);
...
%             P3_amp_diff=P3_amp_pos+P3_amp_neg;
            ...
            EEG_mat3=[zeros(size(EEG_mat2,1),1) zeros(size(EEG_mat2,1),1)];
            EEGGR_mat3=[Behav_mat 0*ones(size(Behav_mat,1),1)];
            for nE=1:63
                EEG_mat3=[EEG_mat3; [P3_amp(:,nE) ERN_amp(:,nE)]];
                EEGGR_mat3=[EEGGR_mat3 ; [Behav_mat nE*ones(size(EEG_mat2,1),1)]];
            end
...
%  mdl_P3_allEnoblock= fitlme(tbl_allE,'P3~Task*Chan*State*TrCond+(1| SubID)');
 ...
 mdl_P3_allE= fitlme(tbl_allE,'P3~nBlock+Task*Chan*State*TrCond+(1| SubID)');
 mdl_ERN_allE= fitlme(tbl_allE,'ERN~nBlock+Task*Chan*State*CorrCond+(1| SubID)');

 tbl_allE2=tbl_allE;
 tbl_allE2.State=reordercats(tbl_allE2.State,{'2','1','3'});
 mdl_P3_allE2= fitlme(tbl_allE2,'P3~nBlock+Task*Chan*State*TrCond+(1| SubID)');
 mdl_ERN_allE2= fitlme(tbl_allE2,'ERN~nBlock+Task*Chan*State*CorrCond+(1| SubID)');
...
ChanIdx=find_trials(this_model.CoefficientNames,'^TrCond_0:Chan');
...
ChanIdx=find_trials(this_model.CoefficientNames,'^Task_2:TrCond_0:Chan');
tempplot=beta(ChanIdx);
tempplotpV=pVal(ChanIdx);
addpath(genpath('/Users/tand0009/Work/local/eeglab14_1_2b/'));
topoplot(tempplot, layout.chaninfo,'style','map','electrodes','off','emarker2',{find(tempplotpV<stat_thr),'.','k',10,2},'whitebk','on');
...
ChanIdx=find_trials(this_model.CoefficientNames,'^CorrCond_0:Chan');
tempplot=beta(ChanIdx);
tempplotpV=pVal(ChanIdx);
addpath(genpath('/Users/tand0009/Work/local/eeglab14_1_2b/'));
topoplot(tempplot, layout.chaninfo,'style','map','electrodes','off','emarker2',{find(tempplotpV<stat_thr),'.','k',10,2},'whitebk','on');
...
ChanIdx=find_trials(this_model.CoefficientNames,'^Task_2:CorrCond_0:Chan');
tempplot=beta(ChanIdx);
tempplotpV=pVal(ChanIdx);
addpath(genpath('/Users/tand0009/Work/local/eeglab14_1_2b/'));
topoplot(tempplot, layout.chaninfo,'style','map','electrodes','off','emarker2',{find(tempplotpV<stat_thr),'.','k',10,2},'whitebk','on');
...
ChanIdx=find_trials(this_model.CoefficientNames,'^State_2:TrCond_0:Chan');
tempplot=beta(ChanIdx);
tempplotpV=pVal(ChanIdx);
addpath(genpath('/Users/tand0009/Work/local/eeglab14_1_2b/'));
...
ChanIdx=find_trials(this_model.CoefficientNames,'^State_3:TrCond_0:Chan');
tempplot=beta(ChanIdx);
tempplotpV=pVal(ChanIdx);
addpath(genpath('/Users/tand0009/Work/local/eeglab14_1_2b/'));
topoplot(tempplot, layout.chaninfo,'style','map','electrodes','off','emarker2',{find(tempplotpV<stat_thr),'.',[1 1 1]*0.5,14,2},'whitebk','on');
...
ChanIdx=find_trials(this_model2.CoefficientNames,'^State_3:TrCond_0:Chan');
...
ChanIdx=find_trials(this_model.CoefficientNames,'^State_2:CorrCond_0:Chan');
tempplot=beta(ChanIdx);
tempplotpV=pVal(ChanIdx);
addpath(genpath('/Users/tand0009/Work/local/eeglab14_1_2b/'));
topoplot(tempplot, layout.chaninfo,'style','map','electrodes','off','emarker2',{find(tempplotpV<stat_thr),'.',[1 1 1]*0.5,14,2},'whitebk','on');
...
ChanIdx=find_trials(this_model.CoefficientNames,'^State_3:CorrCond_0:Chan');
tempplot=beta(ChanIdx);
tempplotpV=pVal(ChanIdx);
addpath(genpath('/Users/tand0009/Work/local/eeglab14_1_2b/'));
topoplot(tempplot, layout.chaninfo,'style','map','electrodes','off','emarker2',{find(tempplotpV<stat_thr),'.',[1 1 1]*0.5,14,2},'whitebk','on');
...
ChanIdx=find_trials(this_model2.CoefficientNames,'^State_3:CorrCond_0:Chan');
tempplot=beta2(ChanIdx);
tempplotpV=pVal2(ChanIdx);
addpath(genpath('/Users/tand0009/Work/local/eeglab14_1_2b/'));
topoplot(tempplot, layout.chaninfo,'style','map','electrodes','off','emarker2',{find(tempplotpV<stat_thr),'.',[1 1 1]*0.5,14,2},'whitebk','on');
