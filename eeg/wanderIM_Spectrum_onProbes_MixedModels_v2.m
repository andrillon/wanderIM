...
%             temp_testres(1:round(size(temp_testres,1)/2),:)=[];
            ...
            temp_behav=[str2num(SubID) nbl npr these_probes(npr,5) this_pr_tridx probe_details temp_corr_go temp_corr_nogo temp_rt_go left_freq right_freq];
            ...
            all_probes_headers={'SubID','nBlock','nProbe','Task','nTrial','Look','State','Orig','Awa','Int','Eng','Perf','Vig','CorrGo','CorrNoGo','RTGo','L_freq','R_freq','SNR','Freq','Chan'};
...
p2F2_Face.State=reordercats(p2F2_Face.State,{'2','1','3'});
pA2_Face.State=reordercats(pA2_Face.State,{'2','1','3'});

pF2_Square=pF_Square;
pIM2_Square=pIM_Square;
p2F2_Square=p2F_Square;
pA2_Square=pA_Square;
pF2_Square.State=reordercats(pF2_Square.State,{'2','1','3'});
pIM2_Square.State=reordercats(pIM2_Square.State,{'2','1','3'});
p2F2_Square.State=reordercats(p2F2_Square.State,{'2','1','3'});
