...
redo.epoching.trial=1;
redo.epoching.baseline=1;
redo.epoching.hb=1;
redo.ica=1;
...
parfor n=1:length(files)
    ...
    %%% Find Triggers
    [start_block_baseline, start_probe, clean_start_trial]=subfun_findtriggers(D,Behav);
...
function [start_block_baseline, start_probe, clean_start_trial]=subfun_findtriggers(D,Behav)
