...
#p$Task<-factor(p$Task,c("2","1"))

pGO<-subset(p,TrCat=="0")
pNOGO<-subset(p,TrCat=="1")

pGOFace<-subset(p,TrCat=="0" & Task=="1")
pGOFace$Task<-droplevels(pGOFace$Task)
pGOSquare<-subset(p,TrCat=="0" & Task=="2")
pGOSquare$Task<-droplevels(pGOSquare$Task)

#mdl4_0 <- lmer(Corr ~ 1 + (1| SubID), data=pGO)
# nBlock nProbe nTrial
#mdl4_1 <- lmer(Corr ~ Task + (1| SubID), data=pGO)
#mdl4_2 <- lmer(Corr ~ Task+nTrial + (1| SubID), data=pGO)
#mdl4_3 <- lmer(Corr ~ Task+nTrial+nBlock + (1| SubID), data=pGO)
#mdl4_4 <- lmer(Corr ~ Task+nTrial+nBlock+State + (1| SubID), data=pGO)
#mdl4_5 <- lmer(Corr ~ Task*nTrial+nBlock+State + (1| SubID), data=pGO)

mdl4_0 <- lmer(Corr ~ 1 + (1| SubID), data=pGO)
# nBlock nProbe nTrial
mdl4_1 <- lmer(Corr ~ Task + (1| SubID), data=pGO)
mdl4_2 <- lmer(Corr ~ Task+nProbe + (1| SubID), data=pGO)
mdl4_3 <- lmer(Corr ~ Task+nProbe+State + (1| SubID), data=pGO)
mdl4_4 <- lmer(Corr ~ Task*nProbe*State + (1| SubID), data=pGO)
mdl4_5 <- lmer(Corr ~ Task*nProbe*State + (1+Task| SubID), data=pGO)


mdl5_0 <- lmer(Corr ~ 1 + (1| SubID), data=pNOGO)
mdl5_1 <- lmer(Corr ~ Task + (1+Task| SubID), data=pNOGO)
mdl5_2 <- lmer(Corr ~ Task+nProbe + (1+Task| SubID), data=pNOGO)
mdl5_3 <- lmer(Corr ~ Task+nProbe+State + (1+Task| SubID), data=pNOGO)
mdl5_4 <- lmer(Corr ~ Task*State+nProbe*State + (1+Task| SubID), data=pNOGO)
...
mdl6_2 <- lmer(Corr ~ Task+nProbe + (1| SubID), data=p2GO)
mdl6_3 <- lmer(Corr ~ Task+nProbe+State + (1| SubID), data=p2GO)
mdl6_4 <- lmer(Corr ~ Task*nProbe*State + (1| SubID), data=p2GO)
mdl6_5 <- lmer(Corr ~ Task*nProbe*State + (1+Task| SubID), data=p2GO)


mdl7_0 <- lmer(Corr ~ 1 + (1| SubID), data=p2NOGO)
mdl7_1 <- lmer(Corr ~ Task + (1+Task| SubID), data=p2NOGO)
mdl7_2 <- lmer(Corr ~ Task+nProbe + (1+Task| SubID), data=p2NOGO)
mdl7_3 <- lmer(Corr ~ Task+nProbe+State + (1+Task| SubID), data=p2NOGO)
mdl7_4 <- lmer(Corr ~ Task*State+nProbe*State + (1+Task| SubID), data=p2NOGO)
#mdl5_5 <- lmer(Corr ~ Task*State + DistProbe + (1+Task+DistProbe| SubID), data=pNOGO)
