...
for nplot=1:3
    subplot(1,3,nplot)
    for ntask=1:2
    [~, hdl]=simpleCorPlot(squeeze(pption_MS(:,ntask,Pairs(nplot,1))),squeeze(pption_MS(:,ntask,Pairs(nplot,2))),{PlotMarkers{ntask},PairColors(nplot,:),PairColors(nplot,:),144},'pearson',0);
