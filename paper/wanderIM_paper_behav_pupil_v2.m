...
for ntask=1%:2
    ...
    all=[];
    for nstate=1:3
        scatter(data_perS{1}{nstate,ntask},data_perS{2}{nstate,ntask},'MarkerFaceColor',Colors(nstate,:),'MarkerFaceAlpha',0.3,'MarkerEdgeColor',Colors(nstate,:),'SizeData',72,'LineWidth',2)
        all=[all ; [data_perS{1}{nstate,ntask} data_perS{2}{nstate,ntask}]];
    end
    for nstate=1:3
        scatter(nanmean(data_perS{1}{nstate,ntask}),nanmean(data_perS{2}{nstate,ntask}),'Marker','s','MarkerFaceAlpha',0.7,'MarkerFaceColor',Colors(nstate,:),'MarkerEdgeColor',Colors(nstate,:),'SizeData',544,'LineWidth',3)
    end
