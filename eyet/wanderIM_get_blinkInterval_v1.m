...
for n=1:length(files)
    ...
    befBl=(EL_events.Blinks.end(1:end-1)-EL_events.Blinks.start(2:end))/1000;
    aftBl=(EL_events.Blinks.start(2:end)-EL_events.Blinks.end(1:end-1))/1000;
    
    all_BI{1}=[all_BI{1} befBl];
    all_BI{2}=[all_BI{2} aftBl];
end
